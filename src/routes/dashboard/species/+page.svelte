<script lang="ts">
	import Table from './table-species.svelte';
	import { Drawer, getDrawerStore } from '@skeletonlabs/skeleton';
	import type { DrawerSettings } from '@skeletonlabs/skeleton';
	import Create from '$lib/components/forms/species/Create.svelte';
	import Update from '$lib/components/forms/species/Update.svelte';
...
<Drawer>
	...
	{:else if $drawerStore.id === 'update'}
		<Update species={$drawerStore.meta?.species} />
	{/if}
</Drawer>
